...
Terima kasih Karna Telah menggunakan Bail TirzzGanzz
Akun Real @Tirzzganzz
Info Update Bail @tirzzganz
`));
console.log(chalk.hex("#6f00f")("Baileys modified by: @Tirzzganzz\n"));
console.log(chalk.hex("#6f00f")("Version 1.0.0 "));
console.log(chalk.hex("#6f00f")("New Update: Senin, 16 Febuari "));
console.log(chalk.hex("#6f00f")("Thanks Udah Pake Bail TirzzGanzz"));
